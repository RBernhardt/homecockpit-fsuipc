...
public class ConnectorWatchdogTest {
    ...
    public void shouldFireOpenEvent() throws Exception {
        ...
        Thread.sleep(1);
        // then
        verify(connectorStateChangedEventListener).stateChanged(eq("CONNECTOR1"), eq(ConnectorStateChangedEventListener.State.OPEN));
        // close
    ...
    public void shouldFireCloseEvent() throws Exception {
        ...
        Thread.sleep(1);
        // then
        verify(connectorStateChangedEventListener).stateChanged(eq("CONNECTOR1"), eq(ConnectorStateChangedEventListener.State.CLOSED));
        // close
        connectorWatchdog.stop();
    }
