...
public class ByteArrayTest {
    ...
    @Test
    public void shouldCompareEqualByteArrays() {
        assertTrue(ByteArray.create("12345", 4).equals(ByteArray.create("12345", 4)));
        assertTrue(ByteArray.create("12345", 4).hashCode() == ByteArray.create("12345", 4).hashCode());
    }
